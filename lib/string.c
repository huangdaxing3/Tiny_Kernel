...
/* 比较两个字符串，若 a_中的字符大于 b_中的字符返回 1，相等时返回 0，否则返回−1． */ 
int8_t strcmp (const char* a, const char* b) { 
    ...
    /* 如果*a 小于*b 就返回−1，否则就属于*a 大于等于*b 的情况。在后面的布尔表达式"*a > *b"中，* 若*a 大于*b，表达式就等于 1，否则表达式不成立，也就是布尔值为 0，恰恰表示*a 等于*b */ 
    return *a < *b ? -1 : *a > *b; 
} 
